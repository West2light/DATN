...
SESSION_BODY="$(PUBLIC_IP="$PUBLIC_IP" GAME_PORT="$GAME_PORT" WEB_GAME_PORT="$WEB_GAME_PORT" WEB_PUBLIC_BASE_URL="$WEB_PUBLIC_BASE_URL" MAP_FILE="$MAP_FILE" ALGORITHM="$ALGORITHM" MAX_PLAYERS="$MAX_PLAYERS" SESSION_CODE="$SESSION_CODE" python3 - <<'PY'
import json
import os
